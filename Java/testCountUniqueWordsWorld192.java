...
public class testCountUniqueWordsWorld192 {
    ...
    public static void main(String args[]) throws FileNotFoundException { 
        ...
        String filename = "../Data/world192.txt";
        ...
        System.out.println("CountUniqueWordsWorld192 " + formatter.format(estimatedTime  / 1000000000d));
        ...
        try {
            ...
            bw.write("CountUniqueWordsWorld192 " + formatter.format(estimatedTime  / 1000000000d));
            bw.newLine();
