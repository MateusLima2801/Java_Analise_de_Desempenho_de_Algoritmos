...
public class testCountUniqueWordsBible {
    ...
    public static void main(String args[]) throws FileNotFoundException { 
        ...
        String filename ="../Data/bible.txt";
        ...
        System.out.println("CountUniqueWordsBible " + formatter.format(estimatedTime  / 1000000000d));
        ...
        try {
            ...
            bw.write("CountUniqueWordsBible " + formatter.format(estimatedTime  / 1000000000d));
            bw.newLine();
