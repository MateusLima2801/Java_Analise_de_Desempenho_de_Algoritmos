...
class testLaplaceJacobi4_100 {
    ...
    public static void main (String[] args) {
       ...
       while ((err > eps) & (count < niter)) {
        ...
        System.out.println("LaplaceJacobi100 " + formatter.format(estimatedTime  / 1000d));
        ...
        try {
            ...
            bw.write("LaplaceJacobi100 " + formatter.format(estimatedTime  / 1000d));
            bw.newLine();
