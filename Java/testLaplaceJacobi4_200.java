...
class testLaplaceJacobi4_200 {
    ...
    public static void main (String[] args) {
       ...
       while ((err > eps) & (count < niter)) {
        ...
        System.out.println("LaplaceJacobi200 " + formatter.format(estimatedTime  / 1000d));
        ...
        try {
            ...
            bw.write("LaplaceJacobi200 " + formatter.format(estimatedTime  / 1000d));
            bw.newLine();
