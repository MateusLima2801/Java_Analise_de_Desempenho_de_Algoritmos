...
class testFibonacci25 {
    ...
    public static void main (String args[]) {
        ...
        System.out.println("IterativeFib25 " + formatter.format(estimatedTime  / 1000000000d));
        ...
        try {
            ...
            bw.write("IterativeFib25 " + formatter.format(estimatedTime  / 1000000000d));
            bw.newLine();
        ...
        b = recFibN(n);
        estimatedTime = System.nanoTime() - startTime;
        System.out.println("RecursiveFib25 " + formatter.format(estimatedTime  / 1000000000d));
        ...
        try {
            ...
            FileWriter fw = new FileWriter(resultsLog.getName(), true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write("RecursiveFib25 " + formatter.format(estimatedTime  / 1000000000d));
            bw.newLine();
