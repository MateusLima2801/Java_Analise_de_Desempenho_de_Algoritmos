...
public class testGaussLegendreQuadrature75 {
    public static void main(String[] args) {
        ...
        System.out.println("Quadrature75 " + formatter.format(estimatedTime  / 1000d));
        ...
        try {
            ...
            bw.write("Quadrature75 " + formatter.format(estimatedTime  / 1000d));
            bw.newLine();
