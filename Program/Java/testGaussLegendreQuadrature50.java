...
public class testGaussLegendreQuadrature50 {
    public static void main(String[] args) {
        ...
        System.out.println("Quadrature50 " + formatter.format(estimatedTime  / 1000d));
        ...
        try {
            ...
            bw.write("Quadrature50 " + formatter.format(estimatedTime  / 1000d));
            bw.newLine();
