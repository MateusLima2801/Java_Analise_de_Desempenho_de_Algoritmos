...
class testLaplaceJacobi4_150 {
    ...
    public static void main (String[] args) {
       ...
       while ((err > eps) & (count < niter)) {
        ...
        System.out.println("LaplaceJacobi150 " + formatter.format(estimatedTime  / 1000d));
        ...
        try {
            ...
            bw.write("LaplaceJacobi150 " + formatter.format(estimatedTime  / 1000d));
            bw.newLine();
