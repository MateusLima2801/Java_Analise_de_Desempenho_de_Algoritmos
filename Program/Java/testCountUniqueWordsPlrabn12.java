...
public class testCountUniqueWordsPlrabn12 {
    ...
    public static void main(String args[]) throws FileNotFoundException { 
        ...
        String filename = "../Data/plrabn12.txt";
        ...
        System.out.println("CountUniqueWordsPlrabn12 " + formatter.format(estimatedTime  / 1000000000d));
        ...
        try {
            ...
            bw.write("CountUniqueWordsPlrabn12 " + formatter.format(estimatedTime  / 1000000000d));
            bw.newLine();
