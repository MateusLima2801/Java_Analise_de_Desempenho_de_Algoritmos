...
public class testCountUniqueWordsBook1 {
    ...
    public static void main(String args[]) throws FileNotFoundException { 
        ...
        String filename = "../Data/book1.txt";
        ...
        System.out.println("CountUniqueWordsBook1 " + formatter.format(estimatedTime  / 1000000000d));
        ...
        try {
            ...
            bw.write("CountUniqueWordsBook1 " + formatter.format(estimatedTime  / 1000000000d));
            bw.newLine();
